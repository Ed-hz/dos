...
HD_PWD='F:/FPGA/Verilog_design/pulse_sync/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log pulse_sync.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source pulse_sync.tcl
