...
HD_PWD='F:/FPGA/Verilog_design/half_adder/sys/half_adder/half_adder.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log half_adder_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source half_adder_0.tcl
