...
HD_PWD='F:/FPGA/Verilog_design/seq_check_1011001/syn/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log seq_check.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source seq_check.tcl
