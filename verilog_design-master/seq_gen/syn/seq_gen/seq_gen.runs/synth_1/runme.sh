...
HD_PWD='F:/FPGA/Verilog_design/seq_gen/syn/seq_gen/seq_gen.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log seq_gen.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source seq_gen.tcl
